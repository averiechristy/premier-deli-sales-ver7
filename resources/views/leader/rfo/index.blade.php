...
<div class="card shadow mb-4">
    ...
    <a href="{{route('leader.createrfo')}}" class="btn btn-pd btn-sm">Buat RFO</a>
        ...
        @include('components.alert')
            ...
            <tr>
                <td>{{$data->no_rfo}}</td>
                  ...
                  <td>    
                  <a href="{{route('leadertampilpesanan',$data->id)}}"><button type="button" class="btn btn-link">
...
<div class="modal fade" id="exampleModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form action="{{route('leadercancelorder')}}" method="post">
        @csrf
...
@endforeach
<tr>
<th colspan="10" style="color:black; text-align: center; font-size:24px;">RFO dari sales</th>
</tr>
...
<td>
 ...
 <a href="{{route('infocancel', $data->id)}}">
