...
<div class="card shadow mb-4">
    ...
    <a href="" class="btn btn-pd btn-sm">Tambah Quotation</a>
...
<td>    
                    <a href="{{route('tampilquote',$data->id)}}">
    Cetak Quotation
</a>
...
<div class="modal fade" id="exampleModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form action="{{route('cancelquotation')}}" method="post">
        @csrf
...
<td>
 ...
 <a href="{{route('infocancelquotation', $data->id)}}">
...
<!-- INI BAGIAN DARI RFO SALES -->

<div class="card shadow mb-4">
    <div class="card-header py-3">
    <h1 class="h3 mb-2 text-gray-800">Quotation Sales</h1>
