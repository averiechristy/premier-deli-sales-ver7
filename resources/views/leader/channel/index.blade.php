...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Channel</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="{{route('leader.channel.create')}}" class="btn btn-pd btn-sm">Tambah Channel</a>
                        </div>
                        <div class="card-body">
...
<th>Updated By</th>
    ...
    <td>{{$data -> updated_by}}</td>
                                        <td> 
                                           ...
                                           <a href="{{route('leadertampilchannel', $data->id)}}"data-toggle="tooltip" class="btn" title='Edit'><i class="fas fa-fw fa-edit" style="color:orange" ></i></a>                 
                              
                           
                           <form method="POST" action="{{route('leaderdeletechannel', $data->id)}}">
        @csrf
