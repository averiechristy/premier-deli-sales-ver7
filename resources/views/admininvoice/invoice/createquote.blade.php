...
<div class="container">
            ...
            <div class="card mt-3">
                                    ...
                                    <div class="card-body">
                                    <form name="saveform" action="{{route('admininvoice.invoice.simpanquote')}}" method="post" onsubmit="return validateForm()">
                                        @csrf                       
    ...
    <div class="row product-field">
        ...
        <div class="col-md-3">
            <div class="form-group mb-4">
                ...
                <input name="price[]" type="number" class="form-control" style="border-color: #01004C;" value="{{$detaildata->quote_price}}" readonly />
            </div>
        </div>
