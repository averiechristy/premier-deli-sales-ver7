...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Catatan Quotation</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="{{route('admininvoice.catatan.create')}}" class="btn btn-pd btn-sm">Tambah Catatan</a>
                        </div>
                        <div class="card-body">
...
<tr>
    <td>{{$data -> judul_catatan}}</td>
    <td><div class="catatan">{{$data -> isi_catatan}}</div></td>
    ...
    <td> 
                                           ...
                                           <a href="{{route('admininvoicetampilcatatan', $data->id)}}"data-toggle="tooltip" class="btn" title='Edit'><i class="fas fa-fw fa-edit" style="color:orange" ></i></a>                 
                              
                           
                           <form method="POST" action="{{route('admininvoicedeletecatatan', $data->id)}}">
        @csrf
