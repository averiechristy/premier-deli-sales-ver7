...
@section('content')
                ...
                <div class="container-fluid">                  
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form name="saveform"  action="{{route('admininvoice.po.create')}}" method="get" onsubmit="return validateForm()">
                    @csrf
...
<div id="myDataTable_filter" class="dataTables_filter">
    <label for="search">Search
        <input id="search" placeholder>
             ...
             @foreach ($so as $data)
            <tr>
                <td><input type="checkbox" name="selected_so[]" value="{{$data->id}}"></td>
