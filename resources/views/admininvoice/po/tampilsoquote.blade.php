...
<div class="card shadow mb-4">
    ...
    <h2 class="h3 mb-2 " style="color:black;"><a href="{{route('admininvoice.po.index')}}">Purchase Order / </a><span>Detail  {{$noPo}}</span></h2>
...
<input id="search" placeholder>
    ...
    <tr>
        <td>{{$item -> no_so}} {{$item -> no_quote}}</td>
    </tr>
    @endforeach
                </tbody>
