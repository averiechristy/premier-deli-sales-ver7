...
@section('content')
    ...
    <div class="left-button">
        <a href="{{route('superadmin.po.showso')}}" class="btn btn-pd btn-sm">Buat Purchase Order</a>
        <span id="notificationBadge" class="badge badge-pill badge-danger">Notifikasi</span>
    </div>
 
    <div class="right-button">
        <a href="{{route('superadmin.po.createpochannel')}}" class="btn btn-info btn-sm  ">Buat PO E-commerce</a>
    </div>
</div>
...
<div id="myDataTable_filter" class="dataTables_filter">
    <label for="search">Search
        <input id="search" placeholder>
            ...
            <td>{{$item -> no_po}}</td>  
            <td>    
            <a href="{{route('superadmintampilsoquote', $item->id)}}"><button type="button" class="btn btn-link">
         Lihat Detail 
...
<td>    
<a href="{{route('superadmintampilpesananpo', $item->id)}}"><button type="button" class="btn btn-link">
         Lihat Detail Produk
...
<div class="modal fade" id="exampleModal{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form action="{{route('superadmincancelpo')}}" method="post">
        @csrf
