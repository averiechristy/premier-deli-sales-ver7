...
@section('content')
                ...
                <a href="{{route('superadmin.produk.create')}}" class="btn btn-pd btn-sm">Tambah Produk</a>
                    <a href="{{ route('superadmindownload.template') }}" class="btn btn-info btn-sm" download>Unduh Template</a>
</div>
