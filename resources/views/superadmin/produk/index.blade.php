...
@section('content')
                ...
                <a href="{{route('superadmin.produk.create')}}" class="btn btn-pd btn-sm">Tambah Data</a>
                    <a href="{{ route('superadmindownload.template') }}" class="btn btn-info btn-sm" download>Download Template</a>
</div>

<div class="importdata mb-3">
<form action="{{ route('superadminimport.products') }}" method="post" enctype="multipart/form-data" style="display: flex; align-items: center;">
    @csrf
                                ...
                                <table  class="table table-bordered"  width="100%" cellspacing="0" style="border-radius: 10px;">
                                 ...
                                 <tr>
                                    ...
                                    <td> 
                                                               ...
                                                               <a href="{{route('superadmintampilproduk', $data->id)}}"data-toggle="tooltip" class="btn" title='Edit'><i class="fas fa-fw fa-edit" style="color:orange" ></i></a>                 
                                                  
                                               
                                               <form method="POST" action="{{ route('superadmindeleteproduk', $data->id) }}">
                            @csrf
