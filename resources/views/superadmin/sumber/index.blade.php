...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Sumber</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="{{route('superadmin.sumber.create')}}" class="btn btn-pd btn-sm">Tambah Sumber</a>
                        </div>
                        <div class="card-body">
...
<th>Updated By</th>
    ...
    <td>{{$item -> updated_by}}</td>
                        ...
                        <a href="{{route('superadmintampilsumber', $item->id)}}"data-toggle="tooltip" class="btn" title='Edit'><i class="fas fa-fw fa-edit" style="color:orange" ></i></a>                 
                                                         
<form method="POST" action="{{route('superadmindeletesumber', $item->id)}}">
        @csrf
