...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="{{route('superadmin.invoice.showso')}}" class="btn btn-pd btn-sm">Buat Invoice</a>
...
<br>
<br>
<a href="{{route('superadmintampildo',$data->id)}}">
...
<div class="modal fade" id="exampleModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form action="{{route('superadmincancelinvoice')}}" method="post">
        @csrf
...
<div class="modal fade" id="closing{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="{{route('superadminclosinginvoice')}}" method="post">
        @csrf
      <input type="hidden"  name="invoice_id" value="{{$data->id}}">
