                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="{{route('manager.kategori.create')}}" class="btn btn-pd btn-sm">Tambah Kategori</a>
                        </div>
                        <div class="card-body">
...
<th>Updated By</th>
    ...
    <td>{{$item -> updated_by}}</td>
                                        <td> 
                                           ...
                                           <a href="{{route('managertampilkategori', $item->id)}}"data-toggle="tooltip" class="btn" title='Edit'><i class="fas fa-fw fa-edit" style="color:orange" ></i></a>                 
                              
                           
                           <form method="POST" action="{{route('managerdeletekategori', $item->id)}}">
        @csrf
