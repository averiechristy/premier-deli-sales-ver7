...
<tr>
    ...
    <td> 
                                           ...
                                           <a href="{{route('managertampilcatatan', $data->id)}}"data-toggle="tooltip" class="btn" title='Edit'><i class="fas fa-fw fa-edit" style="color:orange" ></i></a>                 
                              
                           
                           <form method="POST" action="{{route('managerdeletecatatan', $data->id)}}">
        @csrf
