...
<div id="myDataTable_filter" class="dataTables_filter">
    <label for="search">Search
        <input id="search" placeholder>
            ...
            <td>{{$item -> no_po}}</td>  
            <td>    
            <a href="{{route('managertampilsoquote', $item->id)}}"><button type="button" class="btn btn-link">
         Lihat Detail 
...
<td>    
<a href="{{route('managertampilpesananpo', $item->id)}}"><button type="button" class="btn btn-link">
         Lihat Detail Produk
...
<td>    
                    <a href="{{route('managertampilpo',$item->id)}}">
