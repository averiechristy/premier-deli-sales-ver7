    ...
    <label for="search">Search
        <input id="search" placeholder>
            ...
            <tr>
                ...
                <td>    
                    <a href="{{route('managertampilpesananinvoice', $data->id)}}"><button type="button"  class="btn btn-link">
    Lihat Detail Produk
</button></a>
</td>
...
<a href="{{route('managertampilinvoice',$data->id)}}">
    Cetak Invoice

</a> 
<br>
<br>
<a href="{{route('managertampildo',$data->id)}}">
